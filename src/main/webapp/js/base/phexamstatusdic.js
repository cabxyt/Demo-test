...
$(function () {
    $("#jqGrid").jqGrid({
        url: '/'+rootPath+'/examStatus/list.do',
        datatype: "json",
        postData:{'empId':empId},
        colModel: [
//        	{ name : 'act',index:'act',width:75,sortable:false}, 
			{ label: '体检ID', name: 'Id', width: 35, key: true,hidden : true,sortable: false },
			{ label: '员工姓名', name: 'key',index:'key', width: 25,editable:true },
			{ label: '身份证号', name: 'value',index:'value', width: 45,editable:true }
        ],
		viewrecords: true,
        height: 400,
        rowNum: 50000,
       ...
       // multiselect: true,
        pager: "#jqGridPager",
        // cellEdit : true,
        //editurl : '/'+rootPath+'/examStatus/edit.do',
...
//        	});
        	...
        	jQuery("#jqGrid").jqGrid('inlineNav', "#jqGridPager",parameter);
//        	 var ids = $("#jqGrid").jqGrid('getDataIDs');
//             console.log(ids);
//             for ( var i = 0; i < ids.length; i++) {
//               var cl = ids[i];
//               be = "<input style='height:22px;width:20px;' type='button' value='E' onclick=\"jQuery('#jqGrid').editRow('"
//                   + cl + "');\" />";
//               se = "<input style='height:22px;width:20px;' type='button' value='S' onclick=\"jQuery('#jqGrid').saveRow('"
//                   + cl + "');\" />";
//               ce = "<input style='height:22px;width:20px;' type='button' value='C' onclick=\"jQuery('#jqGrid').restoreRow('"
//                   + cl + "');\" />";
